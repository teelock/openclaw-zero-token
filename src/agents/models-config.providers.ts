...
export {
  ...
  buildXiaomiMimoWebProvider,
  buildZWebProvider,
  discoverClaudeWebModels,
  discoverDeepseekWebModels,
  discoverDoubaoWebModels,
} from "../zero-token/bridge/web-providers.js";
...
export async function resolveImplicitProviders(params: {
  ...
  const perplexityWebKey =
    resolveEnvApiKeyVarName("perplexity-web") ??
    resolveApiKeyFromProfiles({ provider: "perplexity-web", store: authStore });

  providers["perplexity-web"] = {
    ...(await buildPerplexityWebProvider({ apiKey: perplexityWebKey })),
    apiKey: perplexityWebKey,
  };
